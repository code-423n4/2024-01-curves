...
- Submit findings [using the C4 form](https://code4rena.com/contests/024-01-rollnetwork/submit)
...
The 4naly3er report can be found [here](https://github.com/code-423n4/024-01-rollnetwork/blob/main/4naly3er-report.md).

Automated findings output for the audit can be found [here](https://github.com/code-423n4/024-01-rollnetwork/blob/main/bot-report.md) within 24 hours of audit opening.
